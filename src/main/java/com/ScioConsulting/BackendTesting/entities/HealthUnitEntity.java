package com.ScioConsulting.BackendTesting.entities;

import java.io.Serializable;

public class HealthUnitEntity implements Serializable {

    private static final long serialVersionUID = 1792014776848281685L;
    ...
    public HealthUnitEntity() {
    }

    public HealthUnitEntity(String region, String region_code, String period, String pct_md_pa_np_mu_aiu, String pct_md_pa_np_mu, String pct_md_mu_aiu, String pct_md_mu, String pct_np_mu_aiu, String pct_np_mu, String pct_pa_mu_aiu, String pct_pa_mu, String pct_hospitals_mu_aiu, String pct_hospitals_mu, String pct_cah_small_rural_mu_aiu, String pct_cah_small_rural_mu) {
        this.region = region;
    ...
    public String toString() {
        return "HealthUnitEntity{" +
                ...
                ", period='" + period + '\'' +
                ", pct_md_pa_np_mu_aiu='" + pct_md_pa_np_mu_aiu + '\'' +
                ", pct_md_pa_np_mu='" + pct_md_pa_np_mu + '\'' +
                ", pct_md_mu_aiu='" + pct_md_mu_aiu + '\'' +
                ", pct_md_mu='" + pct_md_mu + '\'' +
                ", pct_np_mu_aiu='" + pct_np_mu_aiu + '\'' +
                ", pct_np_mu='" + pct_np_mu + '\'' +
                ", pct_pa_mu_aiu='" + pct_pa_mu_aiu + '\'' +
                ", pct_pa_mu='" + pct_pa_mu + '\'' +
                ", pct_hospitals_mu_aiu='" + pct_hospitals_mu_aiu + '\'' +
                ", pct_hospitals_mu='" + pct_hospitals_mu + '\'' +
                ", pct_cah_small_rural_mu_aiu='" + pct_cah_small_rural_mu_aiu + '\'' +
                ", pct_cah_small_rural_mu='" + pct_cah_small_rural_mu + '\'' +
                '}';
    }
}
